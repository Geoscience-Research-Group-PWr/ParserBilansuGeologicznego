...
stats = None
years = []
types = [('00', ""), ('01', 'BARYT I FLUORYT'), ('02', 'BENTONITY I IŁY BENTONITOWE'), ('03', 'BURSZTYNY'),
         ('04', 'DOLOMITY'), ('05', 'FOSFORYTY'), ('06', 'GAZ ZIEMNY'), ('07', 'GIPS I ANHYDRYT'),
         ('08', 'GLINY CERAMICZNE'), ('09', 'GLINY OGNIOTRWAŁE'), ('10', 'KALCYT'), ('11', 'KAMIENIE ŁAMANE I BLOCZNE'),
         ('12', 'KREDA'), ('13', 'KRZEMIENIE'), ('14', 'KWARC ŻYŁOWY'), ('15', 'KWARCYTY OGNIOTRW ŁE'),
         ('16', 'MAGNEZYTY'), ('17', 'OSADY GLAUKONITONOŚNE'), ('18', 'PIASKI FORMIERSKIE'), ('19', 'PIASKI I ŻWIRY'),
         ('20', 'PIASKI KWARCOWE'), ('21', 'PIASKI Z MINERAŁAMI CIĘŻKIMI'), ('22', 'ROPA NAFTOWA'),
         ('23', 'RUDY CYNKU I OŁOWIU'), ('24', 'RUDY MIEDZI I SREBRA'), ('25', 'RUDY MOLIBDENOWO-WOLFRAMOWO-MIEDZIOWE'),
         ('26', 'RUDY NIKLU'), ('27', 'RUDY ZŁOTA, ARSENU I CYNY'), ('28', 'RUDY ŻELAZA, TYTANU I WANADU'),
         ('29', 'SIARKA'), ('30', 'SKAŁA DIATOMITOWA'), ('31', 'SOLANKI, WODY LECZNICZE I TERMALNE'),
         ('32', 'SOLE POTASOWO-MAGNEZOWE'), ('33', 'SUROWCE DLA PRAC INŻYNIERSKICH'),
         ('34', 'SUROWCE ILASTE CERAMIKI BUDOWLANEJ'), ('35', 'SUROWCE ILASTE DO PROD. CEMENTU'),
         ('36', 'SUROWCE ILASTE DO PROD. KRUSZYWA LEKKIEGO'), ('37', 'SUROWCE ILASTE'), ('38', 'SUROWCE KAOLINOWE'),
         ('39', 'SUROWCE SKALENIOWE'), ('40', 'SUROWCE SZKLARSKIE'), ('41', 'SÓL KAMIENNA'), ('42', 'TORFY'),
         ('43', 'WAPIENIE I MARGLE'), ('44', 'WĘGLE BRUNATNE'), ('45', 'WĘGLE KAMIENNE'), ('46', 'ZIEMIA KRZEMIONKOWA'),
         ('47', 'ŁUPKI FYLLITOWE, KWARCYTOWE I ŁYSZCZYKOWE'), ('48', 'ŻWIRKI FILTRACYJNE')]
counties = [('00', ""),
            ('01', 'Wrocław'),
            ('02', 'Jelenia Góra'),
            ('03', 'Legnica'),
